...
class EmojiCollectionViewController: UICollectionViewController {
    ...
    func generateColumnLayout() -> UICollectionViewLayout {
        ...
        group.contentInsets = NSDirectionalEdgeInsets(top: padding, leading: 0, bottom: padding, trailing: 0)
    ...
    override func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, at indexPath: IndexPath) -> UICollectionReusableView {
        let header = collectionView.dequeueReusableCell(withReuseIdentifier: kind, for: indexPath) as! EmojiCollectionViewHeader
